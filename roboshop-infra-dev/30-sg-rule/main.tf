...
resource "aws_security_group_rule" "user_bakcend_alb" {
  type              = "ingress"
...
resource "aws_security_group_rule" "cart_bakcend_alb" {
  type              = "ingress"
...
resource "aws_security_group_rule" "shipping_bakcend_alb" {
  type              = "ingress"
...
resource "aws_security_group_rule" "payment_bakcend_alb" {
  type              = "ingress"
